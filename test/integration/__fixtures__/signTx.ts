import type { AssetGroup, DeviceOwnedAddress, ErrorBase,SignedTransactionData, Transaction, TxInput, TxOutput, TxOutputDestination } from "../../../src/Bcc"
import {DeviceStatusError, InvalidDataReason, TxAuxiliaryDataSupplementType} from "../../../src/Bcc"
import { AddressType, CertificateType, Networks, TxAuxiliaryDataType, TxOutputDestinationType, utils } from "../../../src/Bcc"
...
const destinations: Record<
  | 'externalColeMainnet'
  | 'externalColeKlarityMainnet'
  | 'externalColeTestnet'
  | 'externalSophie'
  | 'externalSophieScripthash'
...
> = {
    externalColeMainnet: {
        amount: 3003112,
        destination: destinations.externalColeMainnet,
    },
    externalColeKlarityMainnet: {
        amount: 3003112,
        destination: destinations.externalColeKlarityMainnet,
    },
    externalColeTestnet: {
        amount: 3003112,
        destination: destinations.externalColeTestnet,
    },
    externalSophie: {
        amount: 1,
        destination: destinations.externalSophie,
    },
    externalSophieScripthash: {
        amount: 1,
        destination: destinations.externalSophieScripthash,
    },
    internalBaseWithStakingKeyHash: {
        amount: 7120787,
...
const coleBase = {
    inputs: [inputs.utxoCole],
    fee: 42,
    ttl: 10,
}

export type TestcaseCole = {
  testname: string
  tx: Transaction
...
export const testsCole: TestcaseCole[] = [
    {
        testname: "Sign tx without change address with Cole mainnet output",
        tx: {
            ...coleBase,
            network: Networks.Mainnet,
            outputs: [outputs.externalColeMainnet],
        },
    ...
    {
        testname: "Sign tx without change address with Cole Klarity mainnet output",
        tx: {
            ...coleBase,
            network: Networks.Mainnet,
            outputs: [outputs.externalColeKlarityMainnet],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        result: {
            txHashHex:
    ...
    {
        testname: "Sign tx without change address with Cole testnet output",
        tx: {
            ...coleBase,
            network: Networks.Testnet,
            outputs: [outputs.externalColeTestnet],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        result: {
            txHashHex:
...
const sophieBase = {
    network: Networks.Mainnet,
    inputs: [inputs.utxoSophie],
    outputs: [outputs.externalColeMainnet],
    fee: 42,
    ttl: 10,
}

export type TestcaseSophie = {
  testname: string
  tx: Transaction
  signingMode: TransactionSigningMode
...
export const testsSophieNoCertificates: TestcaseSophie[] = [
    {
    ...
    },
    {
        ...
        tx: {
            ...sophieBase,
            outputs: [outputs.externalSophie],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        additionalWitnessPaths: [],
    ...
    {
        testname: "Sign tx without change address with Sophie scripthash output",
        tx: {
            ...sophieBase,
            network: Networks.Testnet,
            outputs: [outputs.externalSophieScripthash],
        },
    ...
    },
    {
        ...
        tx: {
            ...sophieBase,
            outputs: [outputs.externalColeMainnet, outputs.internalBaseWithStakingPath],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        additionalWitnessPaths: [],
        result: {
    ...
    },
    {
        ...
        tx: {
            ...sophieBase,
            outputs: [outputs.externalColeMainnet, outputs.internalBaseWithStakingKeyHash],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        additionalWitnessPaths: [],
        result: {
    ...
    },
    {
        ...
        tx: {
            ...sophieBase,
            outputs: [outputs.externalColeMainnet, outputs.internalEnterprise],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        additionalWitnessPaths: [],
        result: {
    ...
    },
    {
        ...
        tx: {
            ...sophieBase,
            outputs: [outputs.externalColeMainnet, outputs.internalPointer],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
        additionalWitnessPaths: [],
        result: {
...
export const testsSophieWithCertificates: TestcaseSophie[] = [
    {
    ...
    },
    {
        ...
        additionalWitnessPaths: [],
        result: {
            // WARNING: only as computed by ledger, not verified with bcc-cli
...
export type TestcaseRejectSophie = {
    testname: string
    tx: Transaction
    signingMode: TransactionSigningMode
    additionalWitnessPaths?: BIP32Path[],
...
export const testsSophieRejects: TestcaseRejectSophie[] = [
    {
...
export const testsEvie: TestcaseEvie[] = [
    {
...
export const testsJen: TestcaseJen[] = [
    ...
    },
    {
        ...
        tx: {
            ...jenBase,
            outputs: [outputs.externalSophie, outputs.multiassetChange],
        },
        signingMode: TransactionSigningMode.ORDINARY_TRANSACTION,
