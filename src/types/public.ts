...
/**
 *  Address type (as defined by the Bcc spec)
 *  @category Addresses
 *  @see [[DeviceOwnedAddress]]
 */
export enum AddressType {
    /**
     * Sophie base addresses
    ...
    /**
     * Sophie pointer address
     * @see [[AddressParamsPointer]]
     */
    POINTER_KEY                         = 0b0100,
    POINTER_SCRIPT                      = 0b0101,
    /**
     * Sophie enterprise address
    ...
    /**
     * Cole address
     * @see [[AddressParamsCole]]
     */
    COLE                               = 0b1000,
    /**
     * Sophie staking rewards address
...
/** 
 * Certificate type (as defined by the Bcc spec)
 * @category Sophie
 * @see [[Certificate]]
 */
...
/**
 * Relay type (as defined by the Bcc spec)
 ...
 * ```
 *  const HD = HARDENED
 *  const ColeAccount0 = [44 + HD, 1815 + HD, 0 + HD];
 *  const SophieChangeAddress0 = [1852 + HD, 1815 + HD, 0 + HD, 1, 0]; 
 * ```
 * 
 * @see [[HARDENED]]
 * @category Basic types
...
/** 
 * Cole address parameters
 * @category Addresses
 * @see [[DeviceOwnedAddress]]
 */
export type AddressParamsCole = {
...
/**
 * Sophie *base* address parameters.
...
/**
 * Sophie *enterprise* address parameters
 * @category Addresses
 * @see [[DeviceOwnedAddress]]
 * */
...
/**
 * Sophie *pointer* address parameters
 * @category Addresses
 * @see [[DeviceOwnedAddress]]
 * */
...
/** Sophie *reward* address parameters.
 * 
 * @category Addresses
 * @see [[DeviceOwnedAddress]]
 */
...
export type ThirdPartyAddressParams = {
    /**
     * Cole or Sophie address in raw hex format (without bech32/base58 encoding)
     */
    addressHex: string
}
...
export type Withdrawal = {
    ...
    stakeCredential: StakeCredentialParams,
    /**
     * Amount (in Entropic) being withdrawn.
...
export enum TxAuxiliaryDataType {
     ...
     * as `[<catalyst registration metadata>, []]` (a.k.a. Jen-era format)
     */
    CATALYST_REGISTRATION = 'catalyst_registration',
}
...
export type CatalystRegistrationParams = {
    ...
    /**
     * Address for receiving voting rewards, Cole-era addresses not supported
     */
...
export type Transaction = {
    /**
     * Bcc network the transaction is supposed to be submitted to.
     */
    network: Network,
    /**
...
/**
 * Native script type (as defined by the Bcc spec)
 * @category Scripts
 * @see [[NativeScript]]
 */
