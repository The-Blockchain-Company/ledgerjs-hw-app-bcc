...
export type ParsedCatalystRegistrationParams = {
    ...
    rewardsDestination: SophieAddressParams
    nonce: Uint64_str
}
...
export type SophieAddressParams = {
...
export type ParsedAddressParams = ColeAddressParams | SophieAddressParams
