...
import { MAX_ENTROPIC_SUPPLY_STR, POOL_REGISTRATION_OWNERS_MAX, POOL_REGISTRATION_RELAYS_MAX } from "./constants"
...
export function parsePoolParams(params: PoolRegistrationParams): ParsedPoolParams {
    ...
    const pledge = parseUint64_str(params.pledge, { max: MAX_ENTROPIC_SUPPLY_STR }, InvalidDataReason.POOL_REGISTRATION_INVALID_PLEDGE)
    const cost = parseUint64_str(params.cost, { max: MAX_ENTROPIC_SUPPLY_STR }, InvalidDataReason.POOL_REGISTRATION_INVALID_COST)
